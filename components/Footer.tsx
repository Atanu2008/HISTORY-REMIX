...
const REMIX_IDEAS = [
    "to see yourself as a sci-fi character.",
    "to create your own movie poster.",
    "to design a fantasy version of your pet.",
    "to generate a custom comic book cover.",
    "to turn a landscape photo into a painting.",
    "to imagine your car in a futuristic setting.",
];
